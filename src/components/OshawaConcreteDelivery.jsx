...
export default function OshawaConcreteDelivery() {
  ...
  const areasServed = [
    { area: "Downtown Oshawa", location: "Central Oshawa" },
    { area: "Kedron", location: "North Oshawa" },
    { area: "Samac", location: "North Oshawa" },
    { area: "Windfields", location: "Northeast Oshawa" },
    { area: "Farewell", location: "East Oshawa" },
    { area: "Lakeview", location: "South Oshawa" },
    { area: "Vanier", location: "West Oshawa" },
    { area: "McLaughlin", location: "Central Oshawa" },
  ];

  const faqs = [
    {
      q: "How much notice do I need to book concrete delivery in Oshawa?",
      a: "For residential orders, 24 to 48 hours is usually enough. Larger commercial or industrial pours need more lead time. Call as early as possible to lock in your delivery window."
    },
    {
      q: "Do you deliver concrete in Oshawa during winter?",
      a: "Yes. Our Cold-Crete formula is built for low-temperature pours. We deliver year-round across Oshawa and Durham Region and will advise on the right mix for your cold-weather project."
    },
    {
      q: "What concrete strength do I need for a driveway in Oshawa?",
      a: "A 32 MPa air-entrained mix is the standard recommendation for residential driveways in Ontario. We confirm the right spec for your specific job when you call."
    },
    {
      q: "Do you also serve Whitby and Ajax from Oshawa?",
      a: "Yes. We cover all of Durham Region including Whitby, Ajax, and Pickering. Call to confirm your address."
    }
  ];
  ...
  return (
    <>
      <SEO 
        ...
        canonical="https://wilchesreadymix.com/ready-mix-concrete-delivery-oshawa/"
        keywords="Concrete delivery Oshawa, Concrete supplier Oshawa, Concrete Oshawa Ontario, Ready mix concrete Oshawa Ontario, Concrete delivery Durham Region, Residential concrete Oshawa, Commercial concrete Oshawa, Industrial concrete Oshawa, Concrete near me Oshawa, Concrete company Oshawa, On-site concrete Oshawa, Concrete pouring Oshawa, Concrete contractor Oshawa, Best concrete supplier Oshawa, Affordable concrete delivery Oshawa"
      />
      <link
      ...
      <div className="bg-black text-white font-['Barlow',sans-serif] w-full min-h-screen">
        ...
        <section className="relative px-6 py-20 md:py-32 border-b border-orange-900/30 overflow-hidden">
          ...
          <div className="max-w-5xl mx-auto relative z-10 text-center animate-fade-in">
            <h1 className="font-black uppercase leading-none mb-6" style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: "clamp(3rem, 8vw, 6rem)" }}>
              Ready Mix Concrete <span style={{ color: "#fe5f00" }}>Delivery in Oshawa</span>
            </h1>
            ...
            <div className="space-y-4 text-lg md:text-xl text-white/80 max-w-4xl mx-auto">
              <p>
                Oshawa has one of the most active construction markets in Durham Region. The city's north end keeps expanding with new residential development, the downtown core is mid-transformation, and the industrial sector along the 401 corridor runs year-round.
              </p>
              <p>
                Every one of those projects needs a concrete supplier who delivers on time with a mix that actually performs. At <strong className="text-white">Wilches Ready Mix Concrete Inc.</strong>, we have been providing ready mix concrete delivery in Oshawa and across the GTA for over 20 years. Family-owned, Etobicoke-based, over 1,500 projects completed across the region. Every load is batched at our plant, checked before it leaves, and delivered ready to pour.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="px-6 py-16 md:py-24 max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <h2 className="font-black uppercase leading-tight" style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: "clamp(2rem, 5vw, 3.5rem)" }}>
              Why the Right Concrete Mix <span style={{ color: "#fe5f00" }}>Matters in Oshawa</span>
            </h2>
            <div className="w-16 h-1 rounded-full" style={{ background: "#fe5f00" }} />
            <p className="text-white/80 text-lg">
              Oshawa sits in full Ontario freeze-thaw territory. Exterior concrete that was not mixed correctly will deteriorate — surface scaling, cracking, and spalling are what happens when air entrainment is skipped or the mix design does not match local conditions.
            </p>
            <p className="text-white/80 text-lg">
              We produce every batch with certified aggregates, a controlled water-to-cement ratio, and proper air entrainment on all exterior mixes. Quality checks run at the plant before dispatch. By the time our truck reaches your Oshawa site, the concrete is right.
            </p>
          </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="font-black uppercase leading-none mb-4" style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: "clamp(2.5rem, 5vw, 4rem)" }}>
                Concrete Services We <span style={{ color: "#fe5f00" }}>Deliver in Oshawa</span>
              </h2>
              <p className="text-white/80 text-lg max-w-2xl mx-auto">
                Whether it is a small residential pour or a large commercial foundation, we have the right mix and the delivery capacity for your Oshawa project.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-zinc-900/50 border border-orange-900/20 p-8 rounded-lg hover:border-[#fe5f00]/50 transition-colors duration-300">
                <h3 className="font-bold text-2xl uppercase mb-4" style={{ fontFamily: "'Barlow Condensed', sans-serif", color: "#fe5f00" }}>
                  Residential Concrete Oshawa
                </h3>
                <p className="text-white/70 leading-relaxed">
                  Oshawa homeowners come to us for driveways, garage floors, walkways, patios, and basement slabs. These are jobs that happen once — and the quality of the concrete determines whether the work holds up through 20 Ontario winters or starts failing in five. We supply the correct mix in the right volume. We tell you what strength your job actually needs, and we arrive in the window we commit to. When a contractor and finishing crew are waiting on site, a late truck is a real cost.
                </p>
              </div>

              <div className="bg-zinc-900/50 border border-orange-900/20 p-8 rounded-lg hover:border-[#fe5f00]/50 transition-colors duration-300">
                <h3 className="font-bold text-2xl uppercase mb-4" style={{ fontFamily: "'Barlow Condensed', sans-serif", color: "#fe5f00" }}>
                  Commercial Concrete Oshawa
                </h3>
                <p className="text-white/70 leading-relaxed">
                  Oshawa's commercial sector — retail along Taunton Road, mixed-use projects near the GO corridor, office developments downtown — all need concrete that meets engineer specs and arrives on a schedule that works around other trades. We supply commercial-grade ready mix to the exact PSI your project requires. Delivery is coordinated with your site supervisor. We understand how concrete fits into a busy site schedule, and we do not disrupt it.
                </p>
              </div>

              <div className="bg-zinc-900/50 border border-orange-900/20 p-8 rounded-lg hover:border-[#fe5f00]/50 transition-colors duration-300">
                <h3 className="font-bold text-2xl uppercase mb-4" style={{ fontFamily: "'Barlow Condensed', sans-serif", color: "#fe5f00" }}>
                  Industrial Concrete Oshawa
                </h3>
                <p className="text-white/70 leading-relaxed">
                  The industrial corridor along Highway 401 in Oshawa has serious concrete demands. Warehouse floors, equipment pads, manufacturing slabs, and loading dock aprons all require high-strength mixes with consistent performance across multiple pours. We supply industrial-grade ready mix with full quality documentation on every load.
                </p>
              </div>
              ...
              <div className="bg-zinc-900/50 border border-orange-900/20 p-8 rounded-lg hover:border-[#fe5f00]/50 transition-colors duration-300">
                ...
                <p className="text-white/70 leading-relaxed">
                  We have supplied concrete for sidewalk programs, road base, and municipal building projects throughout Durham Region. Public-sector contracts come with specific mix design and documentation requirements — we have met them before and can meet them for Oshawa area projects.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="px-6 py-16 md:py-24 max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="font-black uppercase leading-none mb-4" style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: "clamp(2rem, 4vw, 3.5rem)" }}>
              Specialty Concrete Mixes <span style={{ color: "#fe5f00" }}>Available for Oshawa Delivery</span>
            </h2>
          ...
          <p className="text-center text-white/80 text-lg max-w-3xl mx-auto">
            <strong style={{ color: "#fe5f00" }}>Cold-Crete</strong> is worth noting specifically for Oshawa contractors. Standard mixes stop performing reliably once temperatures drop below a certain threshold. Cold-Crete is engineered for Ontario winter conditions — your pour schedule does not have to shut down when the temperature falls.
          </p>
        </section>
          ...
          <div className="max-w-6xl mx-auto px-6 py-16 md:py-24 grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div>
              <h2 className="font-black uppercase leading-tight mb-6" style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: "clamp(2rem, 3.5vw, 3rem)" }}>
                Areas We <span style={{ color: "#fe5f00" }}>Serve in Oshawa</span>
              </h2>
              ...
              <p className="text-white/80 italic">
                Not on this list? Call <a href="tel:647-891-4740" className="text-[#fe5f00] font-bold hover:underline">647-891-4740</a>. We cover all of Durham Region and will confirm delivery to your address directly.
              </p>
            </div>
            ...
            <div>
              <h2 className="font-black uppercase leading-tight mb-6" style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: "clamp(2rem, 3.5vw, 3rem)" }}>
                Why Oshawa Contractors Choose <span style={{ color: "#fe5f00" }}>Wilches Ready Mix</span>
              </h2>
              <div className="w-16 h-1 mb-8 rounded-full" style={{ background: "#fe5f00" }} />
              
              <div className="space-y-6">
                <p className="text-white/80 text-lg">
                  We have been in this business for over 20 years. Our team has poured in every Ontario condition, on every type of project, across the GTA and Durham Region.
                </p>
                <div className="flex gap-4 items-start">
                  ...
                  <p className="text-white/80 text-lg">
                    We are a family business. When you call, you speak to someone personally responsible for your order — not a booking system or a call centre.
                  </p>
                </div>
                <div className="flex gap-4 items-start">
                  <div className="w-8 h-8 rounded-full flex-shrink-0 flex items-center justify-center mt-1" style={{ background: "rgba(254,95,0,0.1)", border: "1px solid #fe5f00" }}>
                  ...
                  <p className="text-white/80 text-lg">
                    We do not overbook. We do not confirm deliveries we cannot make.
                  </p>
                </div>
                <div className="flex gap-4 items-start">
                  <div className="w-8 h-8 rounded-full flex-shrink-0 flex items-center justify-center mt-1" style={{ background: "rgba(254,95,0,0.1)", border: "1px solid #fe5f00" }}>
                  ...
                  <p className="text-white/80 text-lg">
                    Every batch is checked before it leaves our plant. 2,363 Google reviews from customers across the GTA reflect what two decades of consistent work actually looks like.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="px-6 py-16 md:py-24 max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="font-black uppercase leading-none mb-4" style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: "clamp(2rem, 4vw, 3.5rem)" }}>
              Common Questions About <span style={{ color: "#fe5f00" }}>Ready Mix Concrete Delivery in Oshawa</span>
            </h2>
          </div>
        ...
        <section className="bg-zinc-900 border-t-4 border-[#fe5f00] py-16 px-6 text-center">
          <div className="max-w-3xl mx-auto">
            <h2 className="font-black uppercase leading-none mb-8" style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: "clamp(2.5rem, 5vw, 4rem)" }}>
              Get a Free Quote for <br /> <span style={{ color: "#fe5f00" }}>Concrete Delivery in Oshawa</span>
            </h2>
